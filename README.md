# Task Planner Agent - AI Agent

## Project Overview

Task Planner Agent - AI Agent is a complete full-stack AI project for **AI Agent**. It includes a FastAPI backend, a React frontend, sample documents, vector search with ChromaDB support, source citations, timeline logs, structured run storage, Docker files, and tests.
...
```text
ai-ai-agent-task-planner-agent/
  backend/
    app/
      main.py
      config.py
